...
namespace day7
{
    class Program
    {
        ...
        {
            var count = BagFinder.GetBagCombos("shiny gold bag", Problem.BagList);
            Console.WriteLine(count);

            // var count = BagFinder.GetInternalBags("shiny gold bag", Problem.BagList);
            // Console.WriteLine(count);
        }

        public static class BagFinder
        {
            public static int GetBagCombos(string bagType, List<string> bagDescriptions)
            {
                ...
                { bags = bags, bagsThatHold = bagsThatHoldType, bagsAdded = true, bagCount = 0 };

                CheckBags(bagAnalyser);

                return bagAnalyser.bagCount;
            }
            ...
            private static void CheckBags(BagAnalyser bagAnalyser)
            {
                ...
                while (bagAnalyser.bagsAdded)
                {
                    ...
                    bagAnalyser.bagCount = bagAnalyser.bagCount + newBagsThatHold.Count;
