        ...
        public static class CodeRunner
        {
            ...
            public static int ProgramRunner(List<Instruction> instructions)
            {
                ...
                while (!visitedIndex.Contains(currentIndex))
                {
                    ...
                    if(lastIndex == 492 || lastIndex == 396){
                    ...
                    try
                    {
                        ...
                        {
                            var newNopIndex = currentIndex +  1;
                            if (!visitedIndex.Contains(newNopIndex))
                            {
                                currentIndex = newNopIndex;
                            }
                            else
                            {
                                currentIndex += instruction.Value;
                        ...
                        {
                            var newJmpIndex = currentIndex + instruction.Value;
                            if (!visitedIndex.Contains(newJmpIndex))
                            {
                                currentIndex = newJmpIndex;
                            }
                            else
                            {
                                currentIndex += 1;
