...
namespace day12
{
    class Program
    {
        ...
        public static class JourneyHelper
        {
            ...
            public static int GetManhanttenDistance(List<string> journey)
            {

                var position = new Position();

                foreach (var move in journey)
                {
                    var moveTupple = GetMoveTuple(move);
            ...
            public static void GetNewPosition(Position position, (string, int) move)
            {
                if (move.Item1 == "R" || move.Item1 == "L")
                {
                    RotateOrientation(position, move);
                    return;
                }
                if (move.Item1 == "F")
                {
            ...
            {
                var positionArray = new string[4] { "N", "E", "S", "W" };
                var currentIndex = Array.IndexOf(positionArray, position.orientaion);
        ...
        public static class Journey
        {
            ...
            public static List<string> Route = new List<string>
            {
                "N2",
                "R90",
                "S2",
